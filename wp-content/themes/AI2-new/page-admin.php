...
$posts = get_posts(array(
    ...
    <div class="d-flex justify-content-center gap-2 flex-wrap">
        <a href="<?php echo home_url('/update-post/?id=' . $post->ID); ?>" class="btn btn-warning btn-sm w-auto w-md-100">Edit</a>
        <a href="<?php echo admin_url('admin-post.php?action=delete_custom_post&post_id=' . $post->ID); ?>" 
           class="btn btn-danger btn-sm w-auto w-md-100"
           onclick="return confirm('Удалить этот пост?');">
           Delete
        </a>
        <a href="<?php echo get_permalink($post->ID); ?>" class="btn btn-info btn-sm w-auto w-md-100">View</a>
    </div>
</td>
                            </tr>
                        <?php endforeach; ?>
